...
<body>
<center><h2>商品品牌编辑<a style="float:right" href="{{url('/brand/index')}}" class="btn btn-default">列表</a></h2><hr></center>
...
@csrf
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
        @if($brand->brand_logo)<img src="{{env('UPLOADS_URL')}}{{$brand->brand_logo}}" height="50" with="50">@endif
