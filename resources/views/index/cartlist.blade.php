...
@section('content')
     ...
     <div class="dingdanlist">
      ...
      <table>
       ...
       <tr goods_id="{{$v->goods_id}}" id="cart_tr">
        <td width="4%"><input type="checkbox" name="1" class="box" id="div_1" num="{{$v->buy_number}}" price="{{$v->goods_price}}" /></td>
        <td class="dingimg" width="15%"><img src="{{env('UPLOADS_URL')}}{{$v->img}}" /></td>
        <td width="50%">
         <h3>{{$v->goods_name}}</h3>
     ...
     <table>
      <tr>
       ...
       <td width="50%">总计：￥<strong class="orange"><div id="div_3"></div></strong></td>
