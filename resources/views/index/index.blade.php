...
<div class="head-top">
    ...
    @else
          <h3 color="red">欢迎 156112050315 登录</h3>
     @endif
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('/proinfo')}}"><img src="{{env('UPLOADS_URL')}}{{$v->img}}" /></a></dt>
     ...
     <div class="prolist">
           @foreach($ishcuo as $v)
      <dl>
       <dt><a href="{{url('/proinfo')}}"><img src="{{env('UPLOADS_URL')}}{{$v->img}}" width="100" height="100" /></a></dt>
       <dd>
