...
<body>
<center><h2>商品分类修改<a style="float:right" href="{{url('/category/index')}}" class="btn btn-default">列表</a></h2><hr></center>

<form action="{{url('/category/update/'.$cate->cate_id)}}" method="post" class="form-horizontal" role="form">
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">分类名称</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="cate_name" value="{{$cate->cate_name}}">
		</div>
	</div>
    <div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<textarea type="text" name="cate_desc" class="form-control" id="firstname" >{{$cate->cate_desc}}</textarea>
		</div>
	</div>
	 <div class="form-group">
